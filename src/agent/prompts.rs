...
pub const CODE_REVIEWER_PROMPT: &str = include_str!("../../prompts/code_reviewer.md");
pub const CODE_SECURITY_AUDITOR_PROMPT: &str =
    include_str!("../../prompts/code_security_auditor.md");
