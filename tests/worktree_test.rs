...
async fn test_create_and_remove_worktree() {
    ...
    let wt_path = manager
        .create_worktree("create1", "kora/create1")
        .await
        .unwrap();
...
async fn test_list_worktrees_includes_created() {
    ...
    let wt_path = manager
        .create_worktree("list1", "kora/list1")
        .await
        .unwrap();
...
async fn test_cleanup_all_removes_kora_worktrees() {
    ...
    manager
        .create_worktree("clean1", "kora/clean1")
        .await
        .unwrap();
    manager
        .create_worktree("clean2", "kora/clean2")
        .await
        .unwrap();
...
async fn test_merge_branch_clean() {
    ...
    let wt_path = manager
        .create_worktree("merge1", "kora/merge1")
        .await
        .unwrap();
    ...
    let result = manager
        .merge_branch(tmp.path(), "kora/merge1")
        .await
        .unwrap();
...
async fn test_merge_branch_conflict() {
    ...
    let wt_path = manager
        .create_worktree("conflict1", "kora/conflict1")
        .await
        .unwrap();
    ...
    let result = manager
        .merge_branch(tmp.path(), "kora/conflict1")
        .await
        .unwrap();
